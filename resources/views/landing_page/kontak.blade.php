          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Lokasi:</h4>
                <p>Jl. Mayor Dasuki Gang Jaya, Jatibarang, Kec. Jatibarang, Kabupaten Indramayu, Jawa Barat 45273</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>pgrijatibarang@gmail.com</p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="Tentang" id="subject" placeholder="Tentang" required>
              </div>
              <div class="form-group mt-3">
                <textarea class="form-control" name="Kritik dan Saran" rows="5" placeholder="Kritik dan Saran" required></textarea>
              </div>
              <div class="my-3">
                <div class="loading">Loading</div>
                <div class="error-message"></div>
                <div class="sent-message">Pesan anda sudah terkiri. Terima Kasih!</div>
              </div>
